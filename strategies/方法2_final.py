...
class Strategy:
    ...
    def decide(self, context):
        ...
        # Apply inertia bonus to currently held stocks to reduce unnecessary
        # turnover at score boundaries.  This is the approved threshold-
        # rebalancing mechanism: new candidates must exceed the held score by a
        # small explicit bonus before replacing an existing position.
