...
Basic work: implement the approved breadth time-series smoothing change,
the approved asymmetric entry-confirmation rule, and the approved asymmetric
panic-exit rule. The performance-work proposal is only documented in
ENGINEER_NOTES and is not merged into this running implementation.
"""
...
class Strategy:
    ...
    def decide(self, context):
        ...
        # Approved basic change from the previous round: replace single-day
        # breadth with the average of BREADTH_SMOOTH_DAYS daily breadth
        # values ending on signal_i.
        breadths = []
        ...
        # Approved current-round change: use the latest single-day breadth as
        # an entry confirmation, while keeping the smoothed breadth for exit.
