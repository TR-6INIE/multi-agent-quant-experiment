...
The performance-work proposal is only documented in ENGINEER_NOTES and is not
merged into this running implementation.
"""
...
class Strategy:
    ...
    def decide(self, context):
        ...
        # Approved basic change: replace single-day breadth with the average of
        # BREADTH_SMOOTH_DAYS daily breadth values ending on signal_i.
        breadths = []
