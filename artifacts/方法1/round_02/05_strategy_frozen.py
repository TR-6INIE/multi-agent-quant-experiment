...
Basic work: implement the approved breadth time-series smoothing change plus
the approved asymmetric entry-confirmation rule. The performance-work proposal
is only documented in ENGINEER_NOTES and is not merged into this running
implementation.
"""
